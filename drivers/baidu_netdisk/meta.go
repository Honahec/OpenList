...
type Addition struct {
	...
	DirectUploadGateway    string `json:"direct_upload_gateway" default:"https://openlist-baidu-upload.honahec.workers.dev"`
	DirectUploadGatewayKey string `json:"direct_upload_gateway_key" secret:"true"`
}
